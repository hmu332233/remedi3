...
public class AnswerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        et_answer_content = (EditText) findViewById(R.id.et_answer_content);
        ...
        btn_add_answer.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Answer answer = new Answer(medicine.getName(),et_answer_content.getText().toString(),medicine.getShape(),
                        medicine.getEnterprise(),medicine.getStandardCode(),medicine.getCategory(),medicine.getEffect(),"","");
                board.setAnswer(answer);

                Intent intent = getIntent();
                intent.putExtra("answer",board);
